...
public class EmailTemplates
{
              ...
              <tr>
                <td style="background-color:#111111;border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:40px 36px;">
                  ...
                  <p style="margin:0 0 28px;color:#6b7280;font-size:15px;line-height:1.6;">
                    We received a request to reset the password for your Pulse account. Use the code below to proceed. This code expires in <span style="color:#f9fafb;font-weight:500;">10 minutes</span>.
                  </p>
    ...
    """;
    public static string PreSignUpCodeEmail(string code) => $"""
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
              ...
              <tr>
                <td style="background-color:#111111;border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:40px 36px;">
                  ...
                  <p style="margin:0 0 28px;color:#6b7280;font-size:15px;line-height:1.6;">
                    Use the code below to confirm your email address and finish creating your Pulse account. This code expires in <span style="color:#f9fafb;font-weight:500;">5 minutes</span>.
                  </p>
                  ...
                  <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;text-align:center;">
                    If you didn't try to sign up for Pulse, you can safely ignore this email.
                  </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
              ...
              <tr>
                <td style="background-color:#111111;border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:40px 36px;">
                  ...
                  <p style="margin:0 0 28px;color:#6b7280;font-size:15px;line-height:1.6;">
                    We received a request to change the email address on your Pulse account to <span style="color:#f9fafb;font-weight:500;">{newEmail}</span>. Use the code below to confirm this change. This code expires in <span style="color:#f9fafb;font-weight:500;">10 minutes</span>.
                  </p>
